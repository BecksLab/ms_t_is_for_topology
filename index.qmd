...
| trait matching     | Interactions can be inferred by a mechanistic framework/relationships | interactions | |  | yes (expert knowledge, trait) |
| binary classifiers | Interactions can be predicted by learning the relationship between interactions and ecologically relevant predictors | interactions | | probabilistic | yes (interaction, trait) |
