...
\begin{tcolorbox}[enhanced jigsaw, colback=white, rightrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, left=2mm, colframe=quarto-callout-note-color-frame, opacityback=0, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Mechanisms that determine feeding links}, breakable, arc=.35mm, leftrule=.75mm, coltitle=black, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, rightrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, left=2mm, colframe=quarto-callout-note-color-frame, opacityback=0, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, breakable, arc=.35mm, leftrule=.75mm, coltitle=black, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, bottomrule=.15mm]
