...
and the same goes for predicting. this is important because it will
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, colback=white, rightrule=.15mm, colframe=quarto-callout-note-color-frame, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 -The anatomy of a food web}, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, left=2mm, opacitybacktitle=0.6, breakable, toprule=.15mm]
