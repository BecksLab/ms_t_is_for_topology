...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Mechanisms that determine feeding links}, opacitybacktitle=0.6, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, colback=white, leftrule=.75mm, rightrule=.15mm, coltitle=black, breakable, bottomtitle=1mm, titlerule=0mm, arc=.35mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, opacitybacktitle=0.6, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, colback=white, leftrule=.75mm, rightrule=.15mm, coltitle=black, breakable, bottomtitle=1mm, titlerule=0mm, arc=.35mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, left=2mm]
