...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, toptitle=1mm, colback=white, leftrule=.75mm, bottomtitle=1mm, opacitybacktitle=0.6, rightrule=.15mm, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Mechanisms that determine feeding links}, titlerule=0mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, left=2mm, breakable, coltitle=black, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, toptitle=1mm, colback=white, leftrule=.75mm, bottomtitle=1mm, opacitybacktitle=0.6, rightrule=.15mm, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, titlerule=0mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, left=2mm, breakable, coltitle=black, arc=.35mm]
