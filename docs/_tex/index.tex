...
\begin{tcolorbox}[enhanced jigsaw, colback=white, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 -The anatomy of a food web}, rightrule=.15mm, breakable, titlerule=0mm, left=2mm, opacitybacktitle=0.6, opacityback=0, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, bottomrule=.15mm, bottomtitle=1mm, arc=.35mm, toprule=.15mm, leftrule=.75mm]
