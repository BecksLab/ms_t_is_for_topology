...
\begin{tcolorbox}[enhanced jigsaw, colback=white, bottomtitle=1mm, arc=.35mm, breakable, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, left=2mm, coltitle=black, rightrule=.15mm, opacityback=0, toprule=.15mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, titlerule=0mm, opacitybacktitle=0.6, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Mechanisms that determine feeding links}]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, bottomtitle=1mm, arc=.35mm, breakable, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, left=2mm, coltitle=black, rightrule=.15mm, opacityback=0, toprule=.15mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, titlerule=0mm, opacitybacktitle=0.6, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}]
