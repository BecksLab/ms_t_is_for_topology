...
\begin{tcolorbox}[enhanced jigsaw, colback=white, left=2mm, rightrule=.15mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, opacityback=0, titlerule=0mm, opacitybacktitle=0.6, bottomrule=.15mm, leftrule=.75mm, arc=.35mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Mechanisms that determine feeding links}, toprule=.15mm, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, left=2mm, rightrule=.15mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, opacityback=0, titlerule=0mm, opacitybacktitle=0.6, bottomrule=.15mm, leftrule=.75mm, arc=.35mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, toprule=.15mm, coltitle=black]
