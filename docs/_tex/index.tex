...
\begin{tcolorbox}[enhanced jigsaw, colback=white, coltitle=black, titlerule=0mm, opacitybacktitle=0.6, bottomrule=.15mm, left=2mm, arc=.35mm, breakable, rightrule=.15mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, toprule=.15mm, opacityback=0, colframe=quarto-callout-note-color-frame]
