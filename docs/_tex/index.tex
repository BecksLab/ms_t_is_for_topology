...
\begin{tcolorbox}[enhanced jigsaw, colback=white, toptitle=1mm, bottomrule=.15mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, opacityback=0, toprule=.15mm, coltitle=black, breakable, arc=.35mm, left=2mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Moving between the feasibility and reality of interactions}, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, toptitle=1mm, bottomrule=.15mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, opacityback=0, toprule=.15mm, coltitle=black, breakable, arc=.35mm, left=2mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, leftrule=.75mm]
