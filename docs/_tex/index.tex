...
as to what determines how a network will look but also how the final
network itself is encoded \emph{i.e.,} its anatomy. (\emph{aside:} there
is the potential to either try and visually summarise how the different
model families define a network (so repeating the motifs used in the
ANATOMY panel) alternatively it would be cool to try and have a panel C
that tries to quantify the different `data ingredients' you would need
to try and construct a network, this would probably be very visually
overwhelming though\ldots)}
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Mechanisms that determine feeding links}, colback=white, breakable, opacitybacktitle=0.6, toptitle=1mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, opacityback=0, left=2mm, rightrule=.15mm, toprule=.15mm, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, colback=white, breakable, opacitybacktitle=0.6, toptitle=1mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, opacityback=0, left=2mm, rightrule=.15mm, toprule=.15mm, titlerule=0mm]
