...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Mechanisms that determine feeding links}, left=2mm, coltitle=black, breakable, bottomtitle=1mm, toprule=.15mm, leftrule=.75mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, colframe=quarto-callout-note-color-frame, titlerule=0mm, rightrule=.15mm, colback=white, bottomrule=.15mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, left=2mm, coltitle=black, breakable, bottomtitle=1mm, toprule=.15mm, leftrule=.75mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, colframe=quarto-callout-note-color-frame, titlerule=0mm, rightrule=.15mm, colback=white, bottomrule=.15mm, opacitybacktitle=0.6]
