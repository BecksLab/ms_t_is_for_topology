...
studying interaction networks (and, within the context of this work,
specifically food webs) is that there is a scarcity of `real world'
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Mechanisms that determine feeding links}, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, left=2mm, opacitybacktitle=0.6, breakable, bottomtitle=1mm, coltitle=black, colback=white, titlerule=0mm, arc=.35mm, bottomrule=.15mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, left=2mm, opacitybacktitle=0.6, breakable, bottomtitle=1mm, coltitle=black, colback=white, titlerule=0mm, arc=.35mm, bottomrule=.15mm, opacityback=0]
