...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, arc=.35mm, toprule=.15mm, bottomtitle=1mm, left=2mm, opacitybacktitle=0.6, colback=white, coltitle=black, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Mechanisms that determine feeding links}, colframe=quarto-callout-note-color-frame, toptitle=1mm, bottomrule=.15mm, leftrule=.75mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, arc=.35mm, toprule=.15mm, bottomtitle=1mm, left=2mm, opacitybacktitle=0.6, colback=white, coltitle=black, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, colframe=quarto-callout-note-color-frame, toptitle=1mm, bottomrule=.15mm, leftrule=.75mm, opacityback=0]
