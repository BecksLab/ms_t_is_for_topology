...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, bottomrule=.15mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, opacityback=0, rightrule=.15mm, left=2mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, breakable, toptitle=1mm, toprule=.15mm, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Mechanisms that determine feeding links}, coltitle=black, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, bottomrule=.15mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, opacityback=0, rightrule=.15mm, left=2mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, breakable, toptitle=1mm, toprule=.15mm, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, coltitle=black, titlerule=0mm]
