...
and not the characteristics (traits), \emph{sensu} neutral processes
(Canard et al., 2012). Alternatively the abundance of species in a
community can influence which interactions are ultimately realised
(Banville et al., 2024; Poisot et al., 2015).
...
network is not constrained by information on real-world dynamics or
conditions. In order to construct a network who's structure is a closer
approximation of reality (localised interactions) one needs to take into
consideration properties of the community as a whole and not just the
