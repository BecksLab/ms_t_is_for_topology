...
\begin{tcolorbox}[enhanced jigsaw, colback=white, rightrule=.15mm, breakable, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, bottomrule=.15mm, arc=.35mm, bottomtitle=1mm, coltitle=black, leftrule=.75mm, toprule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Why we need to aggregate networks at different scales: A
hypothetical case study}, left=2mm, opacityback=0, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame]
