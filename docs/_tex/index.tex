...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, leftrule=.75mm, titlerule=0mm, arc=.35mm, toprule=.15mm, left=2mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, breakable, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Mechanisms that determine feeding links}, toptitle=1mm, opacitybacktitle=0.6, rightrule=.15mm, bottomrule=.15mm, colback=white, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, leftrule=.75mm, titlerule=0mm, arc=.35mm, toprule=.15mm, left=2mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, breakable, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, toptitle=1mm, opacitybacktitle=0.6, rightrule=.15mm, bottomrule=.15mm, colback=white, opacityback=0]
