...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, leftrule=.75mm, breakable, rightrule=.15mm, opacitybacktitle=0.6, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Mechanisms that determine feeding links}, colback=white, titlerule=0mm, opacityback=0, colframe=quarto-callout-note-color-frame, left=2mm, bottomtitle=1mm, coltitle=black, toptitle=1mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white]
