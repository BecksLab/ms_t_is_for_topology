...
\begin{tcolorbox}[enhanced jigsaw, breakable, coltitle=black, leftrule=.75mm, left=2mm, rightrule=.15mm, colback=white, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Why we need to aggregate networks at different scales: A
hypothetical case study}, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, bottomrule=.15mm, arc=.35mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, opacityback=0]
