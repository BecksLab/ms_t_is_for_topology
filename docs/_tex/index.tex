...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, coltitle=black, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, toprule=.15mm, rightrule=.15mm, left=2mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, colback=white, breakable, titlerule=0mm, toptitle=1mm, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 -The anatomy of a food web}, opacityback=0, leftrule=.75mm]
