...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, opacityback=0, rightrule=.15mm, opacitybacktitle=0.6, toprule=.15mm, titlerule=0mm, colframe=quarto-callout-note-color-frame, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, breakable, left=2mm, colback=white, bottomrule=.15mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Why we need to aggregate networks at different scales: A
hypothetical case study}, leftrule=.75mm]
