...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, opacitybacktitle=0.6, arc=.35mm, breakable, colback=white, coltitle=black, bottomtitle=1mm, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 -The anatomy of a food web}, opacityback=0, left=2mm, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, titlerule=0mm]
