...
(2023), where a metaweb is downsampled into smaller realisations based
on better data/knowledge as to which species are occurring at a specific
location - however arguably these are still firmly in the space of
feasible interactions for the specific location but are approaching a
better approximation of `reality'\ldots{}

\textbf{2. Evolutionary compatibility}
