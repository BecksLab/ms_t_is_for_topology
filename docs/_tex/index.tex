...
hypothetical case study}, toprule=.15mm, colback=white, colframe=quarto-callout-note-color-frame, arc=.35mm, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, breakable, coltitle=black, left=2mm, bottomrule=.15mm, bottomtitle=1mm, opacityback=0, leftrule=.75mm, opacitybacktitle=0.6, rightrule=.15mm]
