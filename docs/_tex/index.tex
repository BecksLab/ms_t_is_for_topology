...
\begin{tcolorbox}[enhanced jigsaw, breakable, rightrule=.15mm, coltitle=black, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Mechanisms that determine feeding links}, titlerule=0mm, colback=white, bottomtitle=1mm, leftrule=.75mm, arc=.35mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, toprule=.15mm, toptitle=1mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, rightrule=.15mm, coltitle=black, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, titlerule=0mm, colback=white, bottomtitle=1mm, leftrule=.75mm, arc=.35mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, toprule=.15mm, toptitle=1mm, left=2mm]
