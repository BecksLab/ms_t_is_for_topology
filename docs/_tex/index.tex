...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, opacityback=0, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Moving between the feasibility and reality of interactions}, colframe=quarto-callout-note-color-frame, toprule=.15mm, breakable, coltitle=black, bottomtitle=1mm, opacitybacktitle=0.6, left=2mm, colback=white, toptitle=1mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, opacityback=0, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, colframe=quarto-callout-note-color-frame, toprule=.15mm, breakable, coltitle=black, bottomtitle=1mm, opacitybacktitle=0.6, left=2mm, colback=white, toptitle=1mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, rightrule=.15mm]
