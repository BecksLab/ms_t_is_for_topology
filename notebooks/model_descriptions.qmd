...
This document provides a more in-depth overview of the different model families as well as linking to some explicit examples.
...
### Co-occurrence
 ...
 Trying to infer interactions from the co-occurrence patterns of species pairs within the community *e.g.,* the geographical lasso [@ohlmannMappingImprintBiotic2018]. This (for me) seems fundamentally flawed and @blanchetCooccurrenceNotEvidence2020 seems to agree with me at least a little bit.
