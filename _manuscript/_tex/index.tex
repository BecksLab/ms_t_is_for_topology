...
\item
  ...
  \item
    ...
    reality the final network is often the result of aggregation over
    multiple timescales.
  \item
...
et al. 2019). LOOK AT Pichler et al. (2020) - overview of different
approaches
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1233}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1233}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.2192}}
...
artificial? network & network (species agnostic) & random & link &
binary \\
...
(species agnostic) & `random' & & \\
energetic & Interactions are determined by foraging theory (feeding
links) & ADBM (Petchey et al. 2008) & interactions & connectance, body
size, abundance & quantitative & & quantitative \\
...
(but structurally constrained?) & interactions, phylogenetic tree, list
of target species (species pool) & & & probabilistic \\
