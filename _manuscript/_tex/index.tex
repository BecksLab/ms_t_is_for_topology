...
\emph{potential} feeding links between species (\emph{i.e.,} although
species \emph{a} may have the ability to consume species \emph{b} it
does not mean that it will be realised `in the field') will be
meaningless if you are interested in understanding feeding preferences
within/between communities as the links are `over distributed'.
