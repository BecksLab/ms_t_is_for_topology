...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Mechanisms that determine feeding links}, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, arc=.35mm, rightrule=.15mm, colback=white, opacityback=0, opacitybacktitle=0.6, bottomrule=.15mm, coltitle=black, breakable, toptitle=1mm, left=2mm, titlerule=0mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, arc=.35mm, rightrule=.15mm, colback=white, opacityback=0, opacitybacktitle=0.6, bottomrule=.15mm, coltitle=black, breakable, toptitle=1mm, left=2mm, titlerule=0mm, leftrule=.75mm]
