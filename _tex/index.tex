...
\begin{tcolorbox}[enhanced jigsaw, colback=white, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Why we need to aggregate networks at different scales: A
hypothetical case study}, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, rightrule=.15mm, left=2mm, breakable, colframe=quarto-callout-note-color-frame, titlerule=0mm, arc=.35mm, opacityback=0, toprule=.15mm, toptitle=1mm, bottomrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6]
...
be used: \emph{note that for now I am using Figure~\ref{fig-box} for
...
the outstanding methodological challenges (shown in orange) we face.}
