...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, rightrule=.15mm, opacityback=0, toptitle=1mm, bottomrule=.15mm, bottomtitle=1mm, colback=white, toprule=.15mm, leftrule=.75mm, breakable, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Mechanisms that determine feeding links}, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, rightrule=.15mm, opacityback=0, toptitle=1mm, bottomrule=.15mm, bottomtitle=1mm, colback=white, toprule=.15mm, leftrule=.75mm, breakable, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, left=2mm]
