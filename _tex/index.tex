...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, coltitle=black, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, left=2mm, toprule=.15mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, opacityback=0, colback=white, breakable, toptitle=1mm, leftrule=.75mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Mechanisms that determine feeding links}, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, coltitle=black, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, left=2mm, toprule=.15mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, opacityback=0, colback=white, breakable, toptitle=1mm, leftrule=.75mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, rightrule=.15mm]
