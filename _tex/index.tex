...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, leftrule=.75mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, breakable, toprule=.15mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, coltitle=black, rightrule=.15mm, toptitle=1mm, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Mechanisms that determine feeding links}, titlerule=0mm, opacitybacktitle=0.6, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, leftrule=.75mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, breakable, toprule=.15mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, coltitle=black, rightrule=.15mm, toptitle=1mm, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, titlerule=0mm, opacitybacktitle=0.6, left=2mm]
