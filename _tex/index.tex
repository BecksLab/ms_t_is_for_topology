...
organization at which they are combined, can take many forms Moulatlet
...
moving between nodes). There is also a myriad of ways in which the links
themselves can be specified. Links between species can be treated
present or absent (\emph{i.e.,} binary), may be defined a, or by
continuous functions which further quantify the strength of an
interaction (Berlow et al., 2004). How these links are specified will
...
feeding links for a community will be meaningless if one is interested
in understanding the flow of energy through the network as the links are
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, breakable, leftrule=.75mm, bottomrule=.15mm, toptitle=1mm, rightrule=.15mm, left=2mm, arc=.35mm, colback=white, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, titlerule=0mm, coltitle=black, opacitybacktitle=0.6, opacityback=0, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Why we need to aggregate networks at different scales: A
...
\item
  ...
  (TBD) span the gamut but it lcks the ability to unpack\ldots{}
