...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, left=2mm, opacityback=0, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, colback=white, rightrule=.15mm, toprule=.15mm, breakable, toptitle=1mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Moving between the feasibility and reality of interactions}, opacitybacktitle=0.6, leftrule=.75mm, coltitle=black, colframe=quarto-callout-note-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, left=2mm, opacityback=0, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, colback=white, rightrule=.15mm, toprule=.15mm, breakable, toptitle=1mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, opacitybacktitle=0.6, leftrule=.75mm, coltitle=black, colframe=quarto-callout-note-color-frame]
