...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, coltitle=black, colback=white, left=2mm, colframe=quarto-callout-note-color-frame, opacityback=0, leftrule=.75mm, breakable, toptitle=1mm, titlerule=0mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Mechanisms that determine feeding links}, rightrule=.15mm, bottomrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, coltitle=black, colback=white, left=2mm, colframe=quarto-callout-note-color-frame, opacityback=0, leftrule=.75mm, breakable, toptitle=1mm, titlerule=0mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, rightrule=.15mm, bottomrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white]
