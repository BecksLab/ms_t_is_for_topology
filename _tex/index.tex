...
hypothetical case study}, colframe=quarto-callout-note-color-frame, colback=white, coltitle=black, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, left=2mm, leftrule=.75mm, bottomrule=.15mm, breakable, toprule=.15mm, opacityback=0, arc=.35mm, toptitle=1mm, titlerule=0mm, rightrule=.15mm]
...
\subsection{How/why do species persist and/or
co-exist?}\label{howwhy-do-species-persist-andor-co-exist}

Specific sub points to consider here is persistence, especially
persistence to perturbation. Again, dynamic networks and
network/community assembly and finally extinctions.
