...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, bottomtitle=1mm, breakable, leftrule=.75mm, colback=white, left=2mm, coltitle=black, opacitybacktitle=0.6, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Why we need to aggregate networks at different scales: A
hypothetical case study}, colframe=quarto-callout-note-color-frame, toptitle=1mm, arc=.35mm, rightrule=.15mm, bottomrule=.15mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white]
