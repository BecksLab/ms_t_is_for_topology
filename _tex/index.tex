...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, titlerule=0mm, rightrule=.15mm, breakable, opacitybacktitle=0.6, opacityback=0, toprule=.15mm, bottomtitle=1mm, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Why we need to aggregate networks at different scales: A
hypothetical case study}, colframe=quarto-callout-note-color-frame, colback=white, left=2mm, coltitle=black, toptitle=1mm, leftrule=.75mm]
