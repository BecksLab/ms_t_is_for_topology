...
\begin{tcolorbox}[enhanced jigsaw, breakable, bottomrule=.15mm, opacityback=0, left=2mm, coltitle=black, colframe=quarto-callout-note-color-frame, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, arc=.35mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Mechanisms that determine feeding links}, colback=white, leftrule=.75mm, rightrule=.15mm, opacitybacktitle=0.6, bottomtitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, bottomrule=.15mm, opacityback=0, left=2mm, coltitle=black, colframe=quarto-callout-note-color-frame, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, arc=.35mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, colback=white, leftrule=.75mm, rightrule=.15mm, opacitybacktitle=0.6, bottomtitle=1mm]
