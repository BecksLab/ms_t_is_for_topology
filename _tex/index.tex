...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 -The anatomy of a food web}, toptitle=1mm, bottomrule=.15mm, opacityback=0, leftrule=.75mm, colback=white, rightrule=.15mm, bottomtitle=1mm, opacitybacktitle=0.6, arc=.35mm, toprule=.15mm, left=2mm, colframe=quarto-callout-note-color-frame]
