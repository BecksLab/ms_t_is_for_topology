...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, coltitle=black, titlerule=0mm, rightrule=.15mm, left=2mm, opacitybacktitle=0.6, toprule=.15mm, colback=white, colframe=quarto-callout-note-color-frame, breakable, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Why we need to aggregate networks at different scales: A
hypothetical case study}, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, toptitle=1mm, arc=.35mm, bottomrule=.15mm]
