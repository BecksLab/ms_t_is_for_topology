...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 -The anatomy of a food web}, leftrule=.75mm, colframe=quarto-callout-note-color-frame, left=2mm, bottomtitle=1mm, opacitybacktitle=0.6, arc=.35mm, bottomrule=.15mm, breakable, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, opacityback=0, colback=white, toprule=.15mm, toptitle=1mm, rightrule=.15mm, coltitle=black]
...
\bottomrule\noalign{}
\endlastfoot
null & Links are randomly distributed within a network & & agnostic &
binary & \\
neutral & Network structure is random, but species abundance determines
links between nodes & abundance & species & binary & Canard et al.
(2012) \\
resource & Networks are interval, species can be ordered on a `niche
axis' & & trophic species & binary & Williams \& Martinez (2008) \\
...
energy & species & quantitative & \\
graph embedding & Interactions can be predicted from the latent traits
of networks & feasibility & species & probabilistic & Strydom et al.
(2023) \\
trait matching & Interactions can be inferred by a mechanistic
framework/relationships & feasibility & species & binary &
...
feasibility & species & binary & Pichler et al. (2020) \\
expert knowledge & `Boots on the ground' ecological knowledge and
observations & feasibility & species & binary & \\
data scavenging & Webscraping to create networks from online databases &
& species & binary & Poisot, Gravel, et al. (2016) (f you squint?) \\
co-occurrence & co-occurrence patterns arise from interactions so we can
use these patterns to reverse engineer the interactions & co-occurence &
species & binary & \\
\end{longtable}
