...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Moving between the feasibility and reality of interactions}, coltitle=black, bottomrule=.15mm, colback=white, opacityback=0, leftrule=.75mm, arc=.35mm, left=2mm, toprule=.15mm, toptitle=1mm, breakable, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, titlerule=0mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm]
