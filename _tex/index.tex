...
\begin{tcolorbox}[enhanced jigsaw, colback=white, opacitybacktitle=0.6, titlerule=0mm, opacityback=0, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, bottomrule=.15mm, toprule=.15mm, toptitle=1mm, left=2mm, colframe=quarto-callout-note-color-frame, breakable, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, leftrule=.75mm, rightrule=.15mm]
