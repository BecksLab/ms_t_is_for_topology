...
\begin{tcolorbox}[enhanced jigsaw, colback=white, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Why we need to aggregate networks at different scales: A
hypothetical case study}, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, left=2mm, bottomtitle=1mm, toptitle=1mm, breakable, opacitybacktitle=0.6, titlerule=0mm, arc=.35mm, bottomrule=.15mm, opacityback=0]
