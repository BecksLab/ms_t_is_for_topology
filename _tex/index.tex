...
Something something about how we can asks questions here about nodes but
instead of it being limited to the fesibility space (e.g.~rewiring
capcity or diet breadth).
...
(Dansereau, Braga, et al., 2024). \textbf{WHY - need three
reasons\ldots{}}

We need to make an effort to more efficiently map the from (structure)
of a network to its function as well as identify how this can
effectively be integrated into policy to make it meaningful and
actionable. Additionally we also need a firmer grasp as to what defines
a `network' as a unit, are the logical (environmental) boundaries
between networks and how do these relate to `management' units and
scales (Fortin et al., 2021).
