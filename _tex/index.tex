...
that's just slipping my mind at the moment.
...
implications between predicting a metaweb and a network realisation. And
here I can't help but think about Poisot et al. (2015) (and probably
other papers) that discuss how the local factors are going to play a
role and even the same pair of species may interact differently in
...
Graph Embedding & Strydom et al. (2022) & latent trait space & \\
...
length will be conserved but connectence might not (I think I understand
what I'm trying to say here)

I think we should also use the Dunne (I think) Cambrian (also think)
network. Because 1) it gives the paleo-centric methods their moment in
...
\item
  ...
  \tightlist
  \item
    \emph{e.g.,} some models wil be in EcoNets.jl, Transfer learning
    (strydom) should be ready to play
  \item
...
\begin{quote}
Thinking very longterm here and maybe a bit beyond the scope but also
