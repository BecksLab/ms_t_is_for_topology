...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, titlerule=0mm, colback=white, leftrule=.75mm, bottomrule=.15mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, breakable, coltitle=black, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, toptitle=1mm, opacityback=0, left=2mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Mechanisms that determine feeding links}]
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, titlerule=0mm, colback=white, leftrule=.75mm, bottomrule=.15mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, breakable, coltitle=black, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, toptitle=1mm, opacityback=0, left=2mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}]
