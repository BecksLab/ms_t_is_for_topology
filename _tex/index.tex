...
\begin{tcolorbox}[enhanced jigsaw, colback=white, toprule=.15mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, bottomtitle=1mm, opacityback=0, rightrule=.15mm, titlerule=0mm, leftrule=.75mm, arc=.35mm, left=2mm, breakable, opacitybacktitle=0.6, toptitle=1mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 -The anatomy of a food web}]
...
`feasibility' vs `realised' food webs
\end{quote}
...
\subsection{Network prediction is scale
...
\subsubsection{How do we predict food webs?}\label{sec-network-build}
...
\subsection{How do we use networks?}\label{how-do-we-use-networks}
...
\addcontentsline{toc}{subsection}{Outstanding questions}
