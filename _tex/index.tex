...
\subsection{At what scale should we be predicting
networks?}\label{at-what-scale-should-we-be-predicting-networks}
...
will influence network dynamics (Rooney et al., 2008).
...
model (BEFW) is addressing, but again it is integrating this with the
