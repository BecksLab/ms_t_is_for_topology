...
\begin{tcolorbox}[enhanced jigsaw, colback=white, titlerule=0mm, bottomtitle=1mm, toprule=.15mm, opacityback=0, breakable, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Why we need to aggregate networks at different scales: A
hypothetical case study}, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, arc=.35mm, coltitle=black, left=2mm, opacitybacktitle=0.6, leftrule=.75mm]
