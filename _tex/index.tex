...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacityback=0, leftrule=.75mm, titlerule=0mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, coltitle=black, toptitle=1mm, colback=white, arc=.35mm, breakable, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 -The anatomy of a food web}, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, bottomrule=.15mm, opacitybacktitle=0.6]
