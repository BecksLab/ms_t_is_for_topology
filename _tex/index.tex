...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Why we need to aggregate networks at different scales: A
hypothetical case study}, rightrule=.15mm, opacityback=0, toprule=.15mm, coltitle=black, colback=white, bottomtitle=1mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, arc=.35mm, breakable, leftrule=.75mm]
...
\pandocbounded{\includegraphics[keepaspectratio]{images/future_use.png}}
