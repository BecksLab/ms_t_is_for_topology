...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, coltitle=black, titlerule=0mm, toptitle=1mm, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Moving between the feasibility and reality of interactions}, left=2mm, colback=white, rightrule=.15mm, colframe=quarto-callout-note-color-frame, breakable, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, bottomtitle=1mm, arc=.35mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, coltitle=black, titlerule=0mm, toptitle=1mm, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, left=2mm, colback=white, rightrule=.15mm, colframe=quarto-callout-note-color-frame, breakable, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, bottomtitle=1mm, arc=.35mm, opacityback=0]
