...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, colback=white, opacityback=0, colframe=quarto-callout-note-color-frame, breakable, opacitybacktitle=0.6, coltitle=black, bottomrule=.15mm, titlerule=0mm, toptitle=1mm, arc=.35mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 -The anatomy of a food web}, left=2mm, rightrule=.15mm, toprule=.15mm, leftrule=.75mm]
