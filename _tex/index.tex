...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, toptitle=1mm, opacityback=0, rightrule=.15mm, bottomrule=.15mm, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Mechanisms that determine feeding links}, coltitle=black, titlerule=0mm, breakable, bottomtitle=1mm, left=2mm, toprule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, toptitle=1mm, opacityback=0, rightrule=.15mm, bottomrule=.15mm, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, coltitle=black, titlerule=0mm, breakable, bottomtitle=1mm, left=2mm, toprule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white]
