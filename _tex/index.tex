...
a shift away from species/populaiton specific measures of the effects of
stress and distrubrance to community level metrics. These metrics, such
as resilience and more generally stability, ecosystem function and
biodiversity \emph{per se}, are natural properties of networks. This
suggests that modern conservation, risk assessment and resource
management requires robust tools to support decision making.

This is also true in the discipline of ecology. Major questions remain
about stability-diversity-productivity relationships and the impacts of
multiple stressors operating at multiple ecological scales. The network
approach to answering these questions specifically allows for questions
about how direct and indirect effects among species in a complex
community, shaped by their environment, deliver fundamental patterns and
understanding of processes in the natural world. and theories that help
define the abundance, distribution, functions and services that
biodiversity provides (Loreau \& de Mazancourt, 2013)
...
theorywe need to be mindful that we are mapping the \emph{correct}
...
Here we will discuss and map different the different network
representations shown in Figure~\ref{fig-process} the the appropriate
research questions and agendas {[}see also Table~\ref{tbl-questions}{]},
as well as highlighting some of the key methodological challenges that
limiting our conceptualisation of a `network' as well as the effective
practical application of them in real world settings.
