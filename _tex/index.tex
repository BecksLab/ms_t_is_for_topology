...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, toptitle=1mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, opacityback=0, breakable, left=2mm, bottomtitle=1mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Mechanisms that determine feeding links}, colback=white, arc=.35mm, toprule=.15mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, toptitle=1mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, opacityback=0, breakable, left=2mm, bottomtitle=1mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, colback=white, arc=.35mm, toprule=.15mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, leftrule=.75mm]
