...
\begin{tcolorbox}[enhanced jigsaw, breakable, arc=.35mm, toptitle=1mm, left=2mm, toprule=.15mm, bottomtitle=1mm, rightrule=.15mm, coltitle=black, opacitybacktitle=0.6, opacityback=0, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Why we need to aggregate networks at different scales: A
hypothetical case study}, leftrule=.75mm, colback=white]
