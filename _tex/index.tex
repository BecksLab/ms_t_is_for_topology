...
\item
  ...
  \item
    ...
    field starts being incorporated into other fields \emph{e.g.,}
    biogeography (Thuiller et al. 2024)
  \end{itemize}
\item
...
\bottomrule\noalign{}
\endlastfoot
null & Network structure is random & \emph{a column that captures naïve
vs a priori knowledge of interactions?} & network & network (species
...
target species (species pool) & mechanistic & trait matching
