...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, colback=white, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Why we need to aggregate networks at different scales: A
hypothetical case study}, titlerule=0mm, colframe=quarto-callout-note-color-frame, left=2mm, breakable, bottomrule=.15mm, opacitybacktitle=0.6, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, arc=.35mm, opacityback=0, leftrule=.75mm]
