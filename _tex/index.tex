...
hierarchy model (Cattin et al. 2004), which adds some component of
phylogenetic clustering/signal\ldots{} so not a single dimension?
\textbf{TODO}.
...
\bottomrule\noalign{}
\endlastfoot
null & Network structure is random & network & link & binary & no \\
neutral & Network structure is random, but species abundance plays a
role & network & & & abundance \\
interval & Networks are interval, can be ordered on a `niche axis' &
