...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, breakable, rightrule=.15mm, opacityback=0, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, bottomtitle=1mm, leftrule=.75mm, opacitybacktitle=0.6, toptitle=1mm, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Why we need to aggregate networks at different scales: A
hypothetical case study}, arc=.35mm, toprule=.15mm, colback=white]
