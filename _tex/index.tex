...
evolutionary compatibility & network reconstruction & metaweb & Pichler
et al. (2020) \\
expert knowledge & `Boots on the ground' ecological knowledge and
observations & evolutionary compatibility & network reconstruction &
metaweb & \\
data scavenging & Webscraping to create networks from online databases &
& network reconstruction & metaweb & Poisot, Gravel, et al. (2016) (if
you squint?) \\
...
& network inference & co-occurrence network & \\
\end{longtable}
