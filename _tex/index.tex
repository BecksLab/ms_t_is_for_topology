...
Predicts
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
Outcome (these terms could be better\ldots)
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
Constraints
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
Interaction
...
\bottomrule\noalign{}
\endlastfoot
null & Network structure is random & network & random & link & binary &
no \\
...
interactions & deterministic & & probabilistic & yes (interaction,
trait) \\
