...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, bottomtitle=1mm, toptitle=1mm, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Why we need to aggregate networks at different scales: A
hypothetical case study}, colback=white, opacityback=0, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, toprule=.15mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, rightrule=.15mm, left=2mm, coltitle=black]
...
\subsection*{1: A global metaweb}\label{a-global-metaweb}
\addcontentsline{toc}{subsection}{1: A global metaweb}
...
\subsection*{2: A seasonal metaweb}\label{a-seasonal-metaweb}
\addcontentsline{toc}{subsection}{2: A seasonal metaweb}
...
\subsection*{3: A seasonal realised
network}\label{a-seasonal-realised-network}
\addcontentsline{toc}{subsection}{3: A seasonal realised network}
...
\subsection*{Data trade off}\label{data-trade-off}
\addcontentsline{toc}{subsection}{Data trade off}
