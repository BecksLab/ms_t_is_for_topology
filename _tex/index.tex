...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, toprule=.15mm, coltitle=black, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, leftrule=.75mm, colback=white, titlerule=0mm, breakable, arc=.35mm, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Mechanisms that determine feeding links}, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, toptitle=1mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, toprule=.15mm, coltitle=black, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, leftrule=.75mm, colback=white, titlerule=0mm, breakable, arc=.35mm, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, toptitle=1mm, left=2mm]
