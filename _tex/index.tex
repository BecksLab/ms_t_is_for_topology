...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, coltitle=black, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, opacityback=0, arc=.35mm, breakable, colback=white, left=2mm, titlerule=0mm, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 -The anatomy of a food web}, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, opacitybacktitle=0.6]
...
\caption{\label{fig-anatomy}Panel \textbf{A} shows the many ways in
...
As discussed in \textbf{?@sec-network-anatomy} there are many ways to
...
Figure~\ref{fig-anatomy}), namely an interest in generating a set of
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, coltitle=black, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, opacityback=0, arc=.35mm, breakable, colback=white, left=2mm, titlerule=0mm, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, opacitybacktitle=0.6]
