...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, bottomrule=.15mm, colback=white, titlerule=0mm, opacitybacktitle=0.6, rightrule=.15mm, leftrule=.75mm, breakable, coltitle=black, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, toptitle=1mm, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Moving between the feasibility and reality of interactions}, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, bottomrule=.15mm, colback=white, titlerule=0mm, opacitybacktitle=0.6, rightrule=.15mm, leftrule=.75mm, breakable, coltitle=black, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, toptitle=1mm, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, arc=.35mm]
