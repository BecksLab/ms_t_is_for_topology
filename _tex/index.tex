...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, bottomtitle=1mm, rightrule=.15mm, colback=white, toprule=.15mm, arc=.35mm, coltitle=black, colframe=quarto-callout-note-color-frame, opacityback=0, leftrule=.75mm, bottomrule=.15mm, opacitybacktitle=0.6, titlerule=0mm, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 -The anatomy of a food web}, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white]
...
links between nodes & abundance & species & binary & \\
