...
components of the network, one needs to understand the different
...
\textbf{potential} or \textbf{realised feeding links}), the magnitude of
the edges (\emph{e.g.,} binary vs probabilistic), and even how the
network itself is delimited (does it represent an aggregation of
...
conclusions that are made (Brimacombe et al., 2023; Proulx et al.,
2005), and it is important to have a strong grasp of what information a
network is attempting to convey.
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, toptitle=1mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, coltitle=black, colback=white, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Mechanisms that determine feeding links}, bottomrule=.15mm, breakable, bottomtitle=1mm, titlerule=0mm, toprule=.15mm, left=2mm]
...
have since gone extinct (Dunne et al., 2008; Yeakel et al., 2014). Of
...
developed. Models such as the niche (Williams \& Martinez, 2000) or
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, toptitle=1mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, coltitle=black, colback=white, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 2 - Assessing model outputs}, bottomrule=.15mm, breakable, bottomtitle=1mm, titlerule=0mm, toprule=.15mm, left=2mm]
