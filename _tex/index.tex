...
(2024), Brimacombe et al. (2023), Moulatlet et al. (2024), Pringle \&
Hutchinson (2020), Polis et al 1991) and the underlying theory as to
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, colback=white, opacityback=0, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1 - Why we need to aggregate networks at different scales: A
hypothetical case study}, titlerule=0mm, breakable, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, coltitle=black, arc=.35mm, bottomtitle=1mm, rightrule=.15mm, opacitybacktitle=0.6, left=2mm, toprule=.15mm, colframe=quarto-callout-note-color-frame]
